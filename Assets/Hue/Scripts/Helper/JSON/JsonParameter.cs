namespace UnityHue{
	...
	public struct JsonParameter {
		...
		public JsonParameter (string parameterKey, object parameterValue)
		{
		...
		{
			this.parameterKey = parameterKey;
			this.parameterValue = parameterValue as object;
		}
		...
		{
			this.parameterKey = parameterKey;
			this.parameterValue = JsonHelper.CreateJsonParameterDictionary(parameterValue) as object;
		}
	}
}